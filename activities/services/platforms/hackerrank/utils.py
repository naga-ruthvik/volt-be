...
class HackerRankMetricsBuilder:
    @staticmethod
    ...
    @classmethod
    def build(cls, models: list[dict]) -> dict:
        questions_solved = 0
        current_points = 0
        total_points = 0
        total_challenges = 0
        ...
        return {
            ...
            "points_completion_percentage": cls._calculate_percentage(
                current_points, total_points
            ),
            "star_completion_percentage": cls._calculate_percentage(
